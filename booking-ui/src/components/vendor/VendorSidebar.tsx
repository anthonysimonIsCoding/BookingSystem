...
const menuItems = [
    { key: "dashboard", label: "Dashboard", icon: "📊", path: "/vendor" },
    { key: "orders", label: "Quản lý đơn hàng", icon: "📋", path: "/vendor/orders" },
    { key: "store", label: "Quản lý cửa hàng", icon: "🏪", path: "/vendor/store" },
];
